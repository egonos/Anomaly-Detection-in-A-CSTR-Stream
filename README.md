...
$T_{\text{low},i}: \quad T_i \sim \mathcal{N}(300,\,3^2) + \mathcal{N}(0,\,(\text{input noise scale} \cdot 350)^2) $

$T_{\text{high},i}: \quad T_i \sim \mathcal{N}(400,\,3^2) + \mathcal{N}(0,\,(\text{input noise scale} \cdot 350)^2) $

$C_{A0,\text{low},i}: \quad C_{A0,i} \sim \mathcal{N}(0.01,\,0.02^2) + \mathcal{N}(0,\,\text{input noise scale}^2) $
 
$C_{A0,\text{high},i}: \quad C_{A0,i} \sim \mathcal{N}(2,\,0.02^2) + \mathcal{N}(0,\,\text{input noise scale}^2) $
 
$Q_{\text{low},i}: \quad Q_i \sim \mathcal{U}(0.2,\,0.5) + \mathcal{N}(0,\,\text{input noise scale}^2) $
 
$Q_{\text{high},i}: \quad Q_i \sim \mathcal{U}(2,\,2.5) + \mathcal{N}(0,\,\text{input noise scale}^2)$
